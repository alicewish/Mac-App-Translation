...
- (void)drawRect:(NSRect)dirtyRect
{
    ...
    if([self isDarkMode]) {
        [[NSColor colorWithRed:44/255.0 green:44.0/255.0 blue:44/255.0 alpha:FILL_OPACITY]setFill];
    } else {
    ...
    [path setLineWidth:LINE_THICKNESS * 2];
     ...
     if([self isDarkMode]) {
         [[NSColor colorWithRed:44/255.0 green:44.0/255.0 blue:44/255.0 alpha:1]setStroke];
     } else {
